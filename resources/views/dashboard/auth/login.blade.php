        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <p class="">Đăng nhập bằng tài khoản của bạn để tiếp tục.</p>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-left">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="email" name="email" type="text" class="form-control" placeholder="example@nhanvieclam.com">
                            </div>

                            <div id="password-field" class="field-wrapper input mb-2">
                                <div class="d-flex justify-content-between">
                                    <label for="password">Mật khẩu</label>
                                    <a href="auth_pass_recovery_boxed.html" class="forgot-pass-link">Quên mật khẩu?</a>
                                </div>

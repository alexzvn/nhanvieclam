...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="page-header"><h3 class="page-title">Tạo tài khoản quản lý</h3></div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="email" id="email" class="form-control" value="{{ old('email') }}"  placeholder="Nhập SĐT" maxlength="10" minlength="10" required>
                          @error('email')
                          <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                        </div>
